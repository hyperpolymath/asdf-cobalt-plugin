...
:url-repo: https://github.com/hyperpolymath/asdf-cobalt-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-cobalt-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-cobalt-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-cobalt-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Cobalt] versions.
...
Cobalt is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Cobalt versions per project

|**Project Isolation**
|Pin Cobalt per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Cobalt version
...
=== Installing Cobalt Versions

[source,bash]
----
asdf list all cobalt
asdf install cobalt latest
asdf install cobalt 0.1.0
----
...
[source,bash]
----
asdf global cobalt 0.1.0
asdf local cobalt 0.1.0
asdf current cobalt
cobalt --version
----
...
* Ensure `cobalt` is on PATH after installation.
* Verify the installed version with `cobalt --version`.
